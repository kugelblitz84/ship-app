...
//     final shipPart = _shipSuffix(trip.companyAndShipInfo.shipName);
//     final product = (trip.product?.productName ?? '').trim();
//     final productLabel = product.isEmpty
//         ? ''
//         : ' • Product: ${_pdfText(product)}';
//     return _pdfText('Trip bill: $from - $to$productLabel$shipPart');
//   }
...
//     final shipPart = _shipSuffix(tx.companyAndShipInfo.shipName);
//     final label = desc.isNotEmpty
//         ? _pdfText(desc)
//         : (base.isNotEmpty ? base : 'Payment entry');
//     return _pdfText('Payment received ($method): $label$shipPart');
//   }
...
//     return _pdfText('Expense ($source, $method): $label$shipPart');
//   }

//   static String _shipSuffix(String? shipName) {
//     final ship = (shipName ?? '').trim();
//     if (ship.isEmpty) return '';
//     return ' • Ship: ${_pdfText(ship)}';
//   }
