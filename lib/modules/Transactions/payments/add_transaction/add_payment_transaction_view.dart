...
import 'add_payment_transaction_controller.dart';
...
class AddTransactionView extends GetView<AddTransactionController> {
  ...
  Widget build(BuildContext context) {
    return AppSliverScaffold(
      ...
      subtitle: 'Record a company payment',
      ...
      child: Form(
        ...
        child: Column(
          ...
          children: [
            ...
            //   subtitle:
            //       'Select company, add payment amount, and optionally link a trip.',
            //   icon: Icons.payments_outlined,
            //   height: 210,
            // ),
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Obx(
                    () => _tripDropdown(
                      trips: controller.visibleTrips,
                      selectedValue: controller.selectedTripId.value,
                      onChanged: controller.onTripChanged,
                      isLoading: controller.isTripsLoading,
                    ),
                  ),
                  SizedBox(height: AppSpacing.base),
                  Obx(
    ...
    return Obx(
      () => Container(
        ...
        child: Column(
          ...
          children: [
            Text('Company Balance Preview', style: AppTextStyles.labelMedium),
            SizedBox(height: AppSpacing.sm),
            Text(
              controller.currentReceivedDisplay.value == '--'
                  ? 'Updated Company Received: --'
                  : 'Updated Received: ৳ ${controller.currentReceivedDisplay.value}',
              style: AppTextStyles.bodyMedium,
            ),
            SizedBox(height: 6.h),
            Text(
              controller.currentDueDisplay.value == '--'
                  ? 'Updated Company Due: --'
                  : 'Updated Due: ৳ ${controller.currentDueDisplay.value}',
    ...
    return Column(
      ...
      children: [
        ...
        DropdownButtonFormField<String>(
          ...
          isExpanded: true,
          decoration: InputDecoration(
            hintText: isLoading ? 'Loading trips...' : 'Select trip (optional)',
            prefixIcon: const Icon(Icons.route_rounded),
          ),
          icon: const Icon(Icons.keyboard_arrow_down_rounded),
          borderRadius: AppRadius.md,
          selectedItemBuilder: (context) => trips
              .map<Widget>(
                (trip) => Text(
