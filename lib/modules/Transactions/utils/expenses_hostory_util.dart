...
//   static const int _tailRowsBeforeNotes = 3;
//   static const int _minRowsBeforeSplitting = 9;
...
//     final shouldSplitTable = ledger.entries.length > _minRowsBeforeSplitting;
//     final splitStartIndex = shouldSplitTable
//         ? ledger.entries.length - _tailRowsBeforeNotes
//         : ledger.entries.length;
//     final leadingEntries = ledger.entries.sublist(0, splitStartIndex);
//     final trailingEntries = ledger.entries.sublist(splitStartIndex);
...
//         ),
//         build: (_) => [
//           _buildHeader(ledger.entries.length, dateFilterLabel: dateFilterLabel),
//           pw.SizedBox(height: 14),
//           _buildSummaryRow(ledger),
//           pw.SizedBox(height: 14),
//           _buildLedgerTitle(),
//           pw.SizedBox(height: 8),
//           if (shouldSplitTable && leadingEntries.isNotEmpty)
//             _buildTable(
//               ledger,
//               entries: leadingEntries,
//               includeClosingRow: false,
//             ),
//           if (shouldSplitTable && leadingEntries.isNotEmpty)
//             pw.SizedBox(height: 8),
//           if (shouldSplitTable)
...
//                 trailingRowCount: trailingEntries.length,
//                 includeClosingRow: true,
//               ),
//             ),
//           _buildTable(
//             ledger,
//             entries: shouldSplitTable ? trailingEntries : ledger.entries,
//             includeClosingRow: true,
//           ),
//           pw.SizedBox(height: 12),
//           if (!shouldSplitTable)
//             pw.NewPage(freeSpace: _estimatedNotesBlockHeight),
//           _buildNotes(),
//         ],
//       ),
//     );
...
//   static pw.Widget _buildHeader(int count, {required String dateFilterLabel}) {
//     return pw.Container(
...
//               pw.SizedBox(height: 4),
//               _metaText('Date Filter', dateFilterLabel),
//             ],
//           ),
//         ],
//       ),
...
//           pw.Expanded(
//             child: _miniStat(
//               'Total Debit (Payment + Due Expense)',
...
//       final pricingDetails = tx.isTrip ? _pricingSnapshot(tx, trip) : '';
...
//           dateRaw: date,
//           description:
//               '$label ($method)$routePart\nCompany: $company$shipPart$pricingPart',
//           product: product,
//           debit: amount,
//           credit: 0,
...
//     final txShip = tx.companyAndShipInfo.shipName?.trim() ?? '';
//     return txShip.isEmpty ? 'N/A' : txShip;
//   }
